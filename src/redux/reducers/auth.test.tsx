...
import { defaultAuthState, AuthenticationStatus, Role, AuthState, Right, getToken, getRightsForRole, getStateFromToken
} from "../../redux/reducers/auth";
import { TOKEN_REMOVE, TOKEN_UPDATE } from "../actions";
...
describe("Auth State", () => {
    ...
    it("returns false if right does not exist in rights array", () => {
      state.rights = [Right.DASHBOARD];
      const result = state.hasStatusAndRight(
